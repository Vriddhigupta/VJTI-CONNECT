...
public class Gradesyprod extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gradesyprod);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference(Constantsprod.DATABASE_PATH_UPLOADS);
    ...
    private void uploadFile(Uri data){
        ...
        storageReference = firebaseStorage.getInstance().getReference();
        StorageReference ref = storageReference.child(Constantsprod.STORAGE_PATH_UPLOADS + System.currentTimeMillis() + ".pdf");
