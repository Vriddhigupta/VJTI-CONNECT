...
public class Gradesyetc extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gradesyetc);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference(Constantsetc.DATABASE_PATH_UPLOADS);
    ...
    private void uploadFile(Uri data){
        ...
        storageReference = firebaseStorage.getInstance().getReference();
        StorageReference ref = storageReference.child(Constantsetc.STORAGE_PATH_UPLOADS + System.currentTimeMillis() + ".pdf");
