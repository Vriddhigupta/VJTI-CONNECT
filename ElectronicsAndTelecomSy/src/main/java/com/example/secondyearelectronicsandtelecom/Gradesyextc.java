...
public class Gradesyextc extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gradesyextc);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference(Constantsextc.DATABASE_PATH_UPLOADS);
    ...
    private void uploadFile(Uri data){
        ...
        storageReference = firebaseStorage.getInstance().getReference();
        StorageReference ref = storageReference.child(Constantsextc.STORAGE_PATH_UPLOADS + System.currentTimeMillis() + ".pdf");
