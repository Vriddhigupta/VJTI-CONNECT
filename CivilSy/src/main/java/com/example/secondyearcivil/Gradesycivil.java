...
public class Gradesycivil extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gradesycivil);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference(Constants_cv.DATABASE_PATH_UPLOADS);
    ...
    private void uploadFile(Uri data){
        ...
        storageReference = firebaseStorage.getInstance().getReference();
        StorageReference ref = storageReference.child(Constants_cv.STORAGE_PATH_UPLOADS + System.currentTimeMillis() + ".pdf");
