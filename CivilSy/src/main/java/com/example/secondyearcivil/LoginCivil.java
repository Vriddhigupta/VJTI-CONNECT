...
public class LoginCivil extends AppCompatActivity {

    EditText username , password , name;
    Button login;

    String correct_username = "SY_CIVIL";
    String correct_password = "SY_CIVIL";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (settings.getString("logged", "").toString().equals("logged")) {
            Intent intent = new Intent(LoginCivil.this, SyCivil.class);
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(LoginCivil.this , "Incomplete inputs" , Toast.LENGTH_LONG).show();
                }
                ...
                {
                    Toast.makeText(LoginCivil.this , "Invalid username/password" , Toast.LENGTH_LONG).show();
                }
            }
        });
