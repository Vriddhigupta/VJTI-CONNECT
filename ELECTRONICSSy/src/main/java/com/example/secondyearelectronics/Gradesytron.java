...
public class Gradesytron extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gradesytron);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference(Constantstron.DATABASE_PATH_UPLOADS);
    ...
    private void uploadFile(Uri data){
        ...
        storageReference = firebaseStorage.getInstance().getReference();
        StorageReference ref = storageReference.child(Constantstron.STORAGE_PATH_UPLOADS + System.currentTimeMillis() + ".pdf");
