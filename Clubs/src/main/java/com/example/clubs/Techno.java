...
public class Techno extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_technoo);
        ...
        sliderItems.add(new SliderItems(R.drawable.tech1));
        sliderItems.add(new SliderItems(R.drawable.tech2));
        sliderItems.add(new SliderItems(R.drawable.tech3));
        sliderItems.add(new SliderItems(R.drawable.tech4));
        sliderItems.add(new SliderItems(R.drawable.tech5));
