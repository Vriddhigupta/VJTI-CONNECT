...
public class Gradesymech extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gradesymech);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference(Constantsmech.DATABASE_PATH_UPLOADS);
    ...
    private void uploadFile(Uri data){
        ...
        storageReference = firebaseStorage.getInstance().getReference();
        StorageReference ref = storageReference.child(Constantsmech.STORAGE_PATH_UPLOADS + System.currentTimeMillis() + ".pdf");
